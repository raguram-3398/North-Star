...
def _disable_gemini_call_pacing(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    (`utils.gemini_client.GEMINI_MIN_CALL_INTERVAL_SECONDS`/
    ...
    """
    monkeypatch.setattr(gc, "GEMINI_MIN_CALL_INTERVAL_SECONDS", 0.0)
    monkeypatch.setattr(gc, "_last_gemini_call_started_at", None)
